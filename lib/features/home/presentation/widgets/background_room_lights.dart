    ...
    return Transform(
      ...
      child: DecoratedBox(
        decoration: const BoxDecoration(
          color: LiteCommerceColors.cardColor,
        ...
        child: Column(
          ...
          children: [
            _RoomInfoRow(
              icon: const Icon(LiteCommerceIcons.thermostat),
              label: const Text('Temperature'),
              data: '${room.temperature}°',
            ),
            height4,
            _RoomInfoRow(
              icon: const Icon(LiteCommerceIcons.waterDrop),
              label: const Text('Air Humidity'),
              data: '${room.airHumidity}%',
            ),
            height4,
            const _RoomInfoRow(
              icon: Icon(LiteCommerceIcons.timer),
              label: Text('Timer'),
              data: null,
            ),
            height12,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  _DeviceIconSwitcher(
                    onTap: (value) {},
                    icon: const Icon(LiteCommerceIcons.music),
...
class _DeviceIconSwitcher extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color =
        value ? LiteCommerceColors.selectedColor : LiteCommerceColors.textColor;
    return InkWell(
      onTap: () => onTap(!value),
      child: Column(
        children: [
            ...
            children: [
              ...
              Text(
                ...
                style: GoogleFonts.montserrat(
                  ...
                  fontSize: 12.sp,
                  color: LiteCommerceColors.textColor.withOpacity(.6),
                ),
              ),
            ],
          ),
